...
window.COURSE_DATA = {
  ...
  sketches: [
    ...
    { id: "mouse-shapes", title: "Mouse Shapes", session: "Session 02", page: "web/mouse-shapes/", source: "source/session-02/mouseshapes/mouseshapes.pde", description: "Use the pointer to control a shape while another removed copys it.", try: "change color mappings, shape size, or removed copyed movement.", tags: ["mouseX", "mapping"], difficulty: "intro", related: ["color-house", "bouncing-ball"] },
  ...
  searchExtras: [
    { type: "coursework", title: "Assignment 1 Example", href: "source/assignments/coursework1_interaction_example.pde", description: "Course example for an interactive coursework.", keywords: "coursework assignment 1 interaction mouse example" },
    { type: "coursework", title: "Assignment 2 Example", href: "source/assignments/coursework2_generative_grid_example.pde", description: "Course example for a generative grid coursework.", keywords: "coursework assignment 2 generative loops grid example" },
    { type: "coursework", title: "Removed coursework Coursework listing", href: "case-coursework/", description: "Previous-year removed coursework removed copyed into the course site.", keywords: "removed coursework coursework listing removed-source-host reference" },
  ],
};
